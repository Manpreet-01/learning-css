        ...
        <div>
            <div className='flex flex-col md:gap-x-12 md:px-16 md:flex-row items-center md:items-start md:justify-between'>
                ...
                <div className='md:flex-1 mt-40 md:mt-24 flex flex-col items-center md:items-start text-center md:text-start gap-y-4'>
                    ...
                    <button
                        className='mt-4 py-3 w-[250px] md:w-[200px] shadow-black shadow-2xl rounded-3xl bg-white'
            ...
            <div className='mt-24 md:mt-16 mb-10 md:mr-24 flex gap-x-5 justify-center md:justify-end items-center text-[30px] text-white'>
                <button className=''><i className="fa-brands fa-facebook"></i></button>
