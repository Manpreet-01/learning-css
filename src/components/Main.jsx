...
export default function Main() {
    return (
        <div id="hero" className='min-h-screen bg-gradient-to-br from-purple-50 via-orange-50 to-transparent'>
            <div id="hero-container" className='sm:pt-5 max-w-4xl mx-auto px-4 pt-6 pb-32 flex flex-col sm:items-center sm:text-center'>
                ...
                <h1 className='text-4xl font-semibold leading-snug sm:leading-normal mt-4 sm:text-6xl'>Web app to desktop app in minutes</h1>
